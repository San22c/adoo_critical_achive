...
class PermisosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permiso" do
    assert_difference('Permiso.count') do
      post permisos_url, params: { permiso: { permiso_type=String: @permiso.permiso_type=String, user_id=references: @permiso.user_id=references } }
    end
  ...
  test "should update permiso" do
    patch permiso_url(@permiso), params: { permiso: { permiso_type=String: @permiso.permiso_type=String, user_id=references: @permiso.user_id=references } }
